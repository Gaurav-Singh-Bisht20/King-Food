...
const CartPage = () => {
  ...
  return cartItems.length>0?(
    <div className='flex w-11/12 bg-slate-50 mx-20 my-10 py-10 justify-between '>
        ...
        <div className=' flex flex-col mx-20 w-[600px]  bg-slate-200 min-w-fit '>
    ...
    </div>):<div className=' flex flex-col justify-between items-center   h-[20rem] bg-slate-300 my-10'>
